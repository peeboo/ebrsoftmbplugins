...
namespace MBSettingSaver
{
    ...
    public class MyStrings : LocalizedStringData
    {
        ...
        //public string SaveNewDesc = "Save Settings to New Config Set";
        //public string RestorePreviousDesc = "Restore the Previous Configuration";
        public string SaveSettingsDesc = "Save and Restore configurations for MB and Plug-ins";
