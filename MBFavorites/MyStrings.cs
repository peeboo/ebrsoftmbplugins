...
namespace MBFavorites
{
    ...
    public class MyStrings : LocalizedStringData
    {
        ...
        public string MBFavoritesOptionsDesc = "Options for the MBFavorites Plug-in.";
        public string MBFavoritesTestOptionDesc = "This option is for the MBFavorites Plug-in.";
